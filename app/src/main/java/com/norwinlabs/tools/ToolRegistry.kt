...
object ToolRegistry {
    ...
    val all: List<Tool> = listOf(
        ...
        Tool(
            ...
            category = "Windhelm",
            action = ToolAction.Navigate(R.id.UE5GuideFragment),
        ),
        Tool(
        ...
        Tool(
            ...
            action = ToolAction.Navigate(R.id.NetScannerFragment),
        ),
        Tool(
